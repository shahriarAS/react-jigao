...
function AskQuestion() {
    ...
    return (
        <div className="row">
            ...
            <div className="col-sm">
                <h4>Questions by you</h4>
                {questions.filter(item => item.user === user.displayName).map(question => (
                    <div key={question.id} className="card w-85">
                        <div className="card-body">
                            <h4 className="card-title">{question.title}</h4>
                            <span className="mr-4"><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-hand-thumbs-up" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="mr-4"><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-hand-thumbs-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            {question.answers ? <span>Total {question.answers.length} Answers</span> : <span>No Answers</span>}
                            <br />
